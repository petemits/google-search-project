...
class GoogleSearchAPI {
    ...
    async startUserInputSearch() {
        ...
        console.log(chalk.cyan('   I will ask you what to search for and provide at least 10 results!'));
        console.log(chalk.gray('─'.repeat(45)));
        ...
        this.rl.question(chalk.magenta('\n🔍 What would you like to search for? '), async (query) => {
            ...
            console.log(chalk.green.bold('\n🎉 Search completed! Check Chrome for your results.'));
            this.rl.close();
        });
    }
...
function showHelp() {
    ...
    console.log('  npm start                 - 🆕 Ask for user input (10+ results + Chrome)');
    console.log('  npm run userinput         - Ask for user input (10+ results + Chrome)');
    ...
    console.log(chalk.white('\nExamples:'));
    console.log('  npm start                 (asks for input)');
    console.log('  npm run search "machine learning"');
    console.log('  npm run userinput');
}
